 ...
 */
static char *font = "CaskaydiaCove NF,FiraCode NF,Powerline,Ubuntu Mono:pixelsize=24:antialias=true:autohint=true";
...
static Shortcut shortcuts[] = {
	...
	{ TERMMOD|ShiftMask,    XK_E,			zoom,           {.f = +1} },
	{ TERMMOD|ShiftMask,    XK_N,			zoom,           {.f = -1} },
